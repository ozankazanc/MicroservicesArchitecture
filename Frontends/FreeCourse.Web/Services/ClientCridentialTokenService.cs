...
namespace FreeCourse.Web.Services
{
    public class ClientCridentialTokenService : IClientCridentialTokenService
    {
        ...
        public ClientCridentialTokenService(IOptions<ServiceApiSettings> serviceApiSettings, IOptions<ClientSettings> clientSettings,
        ...
        public async Task<string> GetToken()
        {
            ...
            var newToken = await _httpClient.RequestClientCredentialsTokenAsync(clientCridentialTokenRequest);
