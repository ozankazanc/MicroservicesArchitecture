...
namespace FreeCourse.Web.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        /// <summary>
        /// memory'de varsa refresh token silinir.
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<Response<bool>> SignIn(SignInInput signInInput)
        {
            ...
            //user bilgileri alinir. sub, name, roles
            var userInfo = await _httpClient.GetUserInfoAsync(userInfoRequest);
            if (userInfo.IsError)
                throw userInfo.Exception;

            //donen json data içerisinde claim hakkındaki bilgiler burada alınır. "name" ve "role" json içerisindeki key'lerdir dikkat.
            ...
            //session bazlı değil, kalıcı bir cookie oluşması için.
            authenticationProperties.IsPersistent = signInInput.IsRemember;

            //login yapar ve kullanici için bir cookie oluşur.
